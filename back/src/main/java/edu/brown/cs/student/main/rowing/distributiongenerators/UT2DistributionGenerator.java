...
/**
 * The UT2DistributionGenerator generates an emission distribution for the UT2 workout type given how long each UT2
 * workout should be.
 */
public class UT2DistributionGenerator {
  ...
  // This static distribution determines the probability of the steady state being broken up into a certain number
  // intervals.
  ...
  public static HashMap<Emission, Double> getLowIntensityDistributionByTime(int minutes) {
    ...
    // generates an emission for each number of intervals, and loads it into the emission distribution to be returned.
