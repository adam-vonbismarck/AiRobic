...
/**
 * The InvalidScheduleException is thrown when a schedule to be filled in does not have the
 * necessary fields to indicate how it should be filled in.
 */
public class InvalidScheduleException extends Exception {
  final Schedule schedule;

  /**
   * The constructor for the InvalidScheduleException, which takes in a message and the invalid
   * schedule.
   *
