...
public class FormatTypeTests {
    ...
    public void testDayAddingEmissions() throws InvalidScheduleException {
        ...
        Assertions.assertEquals(this.testDay.getDay(), DayOfWeek.FRIDAY);
        Assertions.assertEquals(this.testDay.getDate(), Optional.of(LocalDate.of(2023, 5, 12)));
        Assertions.assertEquals(this.testDay.getEmissions(), new ArrayList<>(List.of(new Emission("workout", 20, "workout1"))));
        Assertions.assertEquals(this.testDay.getIntensityLength(), 2);
        Assertions.assertEquals(this.testDay.getNumberOfWorkouts(), 2);
        Assertions.assertEquals(this.testDay.getPlanCopy(), new ArrayList<>(List.of(
                new Day.WorkoutDescription(Workout._2K, 30),
    ...
    public void testDayInvalid() {
        Exception exn =
                Assertions.assertThrows(
                        ...
                        () -> {
                            new Day(null, null, 0, null,
                                    Optional.of(LocalDate.of(2023, 4, 5)), new ArrayList<>());
                        });
        ...
        exn =
                Assertions.assertThrows(
                        ...
                        () -> {
                            new Day("day", new ArrayList<>(), 0, DayOfWeek.FRIDAY,
                                    Optional.of(LocalDate.of(2023, 5, 2)), new ArrayList<>());
                        });
        Assertions.assertEquals(
                exn.getMessage(),
    ...
    public void testWeekValid() throws InvalidScheduleException {
        ...
        days.add(new Day("day", new ArrayList<>(), 7,
                DayOfWeek.MONDAY, Optional.of(LocalDate.of(2023, 5, 8)),
                new ArrayList<>()));
        Week week = new Week("week", days);
        Assertions.assertEquals(week.getDaySubset(0, 1), List.of(this.testDay));
        Assertions.assertEquals(week.getDaySubset(0, 2), List.of(this.testDay, new Day("day", new ArrayList<>(), 7,
                DayOfWeek.MONDAY, Optional.of(LocalDate.of(2023, 5, 8)),
                new ArrayList<>())));
    }
    ...
    public void testScheduleFlattenWithDays() throws InvalidScheduleException {
        ...
        daysTwo.add(new Day("day", new ArrayList<>(), 4,
                DayOfWeek.THURSDAY, Optional.of(LocalDate.of(2023, 5, 4)),
                new ArrayList<>()));
        Week week = new Week("week", days);
        Week weekTwo = new Week("week", daysTwo);
        Schedule schedule = new Schedule("schedule", List.of(week, weekTwo), week);
        Assertions.assertEquals(schedule.flatten().days(), List.of(this.testDay,
                new Day("day", new ArrayList<>(), 7,
                        DayOfWeek.MONDAY, Optional.of(LocalDate.of(2023, 5, 8)),
                        new ArrayList<>()),
                new Day("day", new ArrayList<>(), 4,
                        DayOfWeek.THURSDAY, Optional.of(LocalDate.of(2023, 5, 4)),
                        new ArrayList<>())));
