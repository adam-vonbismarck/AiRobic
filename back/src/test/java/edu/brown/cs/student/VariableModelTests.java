...
public class VariableModelTests {
  ...
  @Test
  public void fuzzVariableGenerator() throws InvalidDatesException, InvalidDistributionException,
          InvalidScheduleException, NoWorkoutTypeException, IOException, FormatterFailureException {
    for (int i = 0; i < NUM_TRIALS; i++) {
      ...
      Schedule schedule = new GenerateGraphLikePlan().generate(mins,
