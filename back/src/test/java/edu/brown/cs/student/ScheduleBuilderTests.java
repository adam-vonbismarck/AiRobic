...
/**
 * This class begins by testing the minutes and workouts methods of the ScheduleBuilder, then
 * verifies that minutesWithDates builds appropriately off of the minutes method. It tests normal
 * conditions of minutes/workouts with the minutes call, and separately tests edge cases of the
 * workouts call.
 */
public class ScheduleBuilderTests {
    ...
    Exception exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .minutes(
                      0, 3, 0.2, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2);
            });
    Assertions.assertEquals(
    ...
    exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .minutes(
                      2000, 3, 0.2, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2);
            });
    Assertions.assertEquals(
        exn.getMessage(), "All schedules must have a number of minutes between 120 and 1200.");
    exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .minutes(
                      600, 1, 0.2, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2);
            });
    Assertions.assertEquals(
        exn.getMessage(),
    ...
    exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .minutes(
                      600, 0, 0.2, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2);
            });
    Assertions.assertEquals(
        exn.getMessage(), "All schedules must have a positive number of weeks.");
  }
    ...
    Exception exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .workouts(
                      -1, 0, 2, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2, 40);
            });
    Assertions.assertEquals(
        exn.getMessage(),
    ...
    exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .workouts(
                      2, -1, 2, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2, 40);
            });
    Assertions.assertEquals(
        exn.getMessage(),
        "All schedules must have a positive number of weeks, high intensity workouts "
    ...
    exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .workouts(
                      4, 6, 1, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2, 40);
            });
    Assertions.assertEquals(
        exn.getMessage(),
        "All schedules must have start days before end days in order to be built.");
    exn =
        Assertions.assertThrows(
            ...
            () -> {
              new ScheduleBuilder()
                  .workouts(
                      4, 6, 3, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2, -1);
            });
    Assertions.assertEquals(
        exn.getMessage(), "All schedules must have a positive low intensity workout length.");
    exn =
        Assertions.assertThrows(
            InvalidScheduleException.class,
            () -> {
              new ScheduleBuilder()
                  .workouts(
                      4, 6, 0, DayOfWeek.TUESDAY, DayOfWeek.MONDAY, Workout._2K, Workout.UT_2, 60);
            });
    Assertions.assertEquals(
        exn.getMessage(),
        "All schedules must have a positive number of weeks, high intensity workouts "
  ...
  public void testMinutesWithDatesShort() {
    ...
    Assertions.assertEquals(
        schedule.weeks().get(0).days().get(0).getDate().get(), LocalDate.of(2023, 5, 2));
    Assertions.assertEquals(
        schedule
            .weeks()
  ...
  /**
   * Tests a short plan that requires loaded dates, with all days of the week for start/end (to
          ...
          schedule =
              new ScheduleBuilder()
                  .minutesWithDates(
                      ...
                      Workout.of("UT2"));
          Assertions.assertEquals(
              schedule.weeks().get(0).days().get(0).getDate().get(), LocalDate.of(2023, 5, i));
          Assertions.assertEquals(
              schedule
                  .weeks()
                  .get(schedule.weeks().size() - 1)
